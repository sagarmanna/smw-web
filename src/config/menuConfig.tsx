      ...
      items: [
        {
          ...
          title: 'Privileges',
          icon: <Users className="h-4 w-4" />,
          url: getMenuSource(locationFlags, 'privileges') === 'legacy' ? '/permission' : '/privileges',
        ...
        },
        {
          ...
          title: 'Staff Members',
          icon: <Users className="h-4 w-4" />,
          url: getMenuSource(locationFlags, 'staffMembers') === 'legacy' ? '/user/index?UserSearch%5Brole_name%5D=staffmember' : '/staff-members',
        ...
        },
        {
          ...
          title: 'Owners',
          icon: <User className="h-4 w-4" />,
          url: getMenuSource(locationFlags, 'owners') === 'legacy' ? '/user/index?UserSearch%5Brole_name%5D=owner' : '/owners',
        ...
        },
        {
          ...
          title: 'Classrooms',
          icon: <Home className="h-4 w-4" />,
          url: getMenuSource(locationFlags, 'classrooms') === 'legacy' ? '/classroom/index' : '/classrooms',
        ...
        },
        {
          ...
          icon: <MapPin className="h-4 w-4" />,
          url: getMenuSource(locationFlags, 'locationSettings') === 'legacy' ? '/location-view' : '/location-view',
