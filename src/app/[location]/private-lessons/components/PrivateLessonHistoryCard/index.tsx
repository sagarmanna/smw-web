...
export const PrivateLessonHistoryCard = React.memo(function PrivateLessonHistoryCard({
  history,
  isLoading = false,
  pagination,
  ...
  const columns = React.useMemo<ColumnDef<PrivateLessonHistory>[]>(() => [
    {
      accessorKey: "message",
      header: "Message",
      cell: ({ row }) => {
        const item = row.original as PrivateLessonHistory;
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
        <CardTitle className="text-lg font-semibold" id="private-lesson-history-title">
          History
        </CardTitle>
      </CardHeader>
      <CardContent className="pt-0">
        {historyError ? (
          ...
          <>
            <div role="region" aria-labelledby="private-lesson-history-title" aria-live="polite">
              <CustomTable
                data={history}
                columns={columns}
                size="compact"
