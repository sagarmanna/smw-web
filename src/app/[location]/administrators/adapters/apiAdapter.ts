...
export const administratorApiAdapter: UserDetailsApiAdapter<
...
> = {
  ...
  updateDetails: async (location, id, details) => {
    const response = await administratorApi.updateAdministratorProfile(location, id, {
  ...
  createEmail: async (location, id, email) => {
    const response = await administratorApi.addAdministratorEmail(location, id, {
      email: email.email,
      label: email.label,
      note: email.note,
  ...
  updateEmail: async (location, id, emailId, email) => {
    const response = await administratorApi.updateAdministratorEmail(location, id, parseInt(emailId), {
      email: email.email ?? '',
      label: email.label ?? '',
      note: email.note,
      isPrimary: email.isPrimary ?? false,
  ...
  deleteEmail: async (location, id, emailId) => {
    const response = await administratorApi.deleteAdministratorEmail(location, id, emailId);
    return response?.success ?? false;
  },
  ...
  createPhone: async (location, id, phone) => {
    const response = await administratorApi.addAdministratorPhone(location, id, {
      number: phone.number,
  ...
  updatePhone: async (location, id, phoneId, phone) => {
    const response = await administratorApi.updateAdministratorPhone(location, id, parseInt(phoneId), {
      number: phone.number ?? '',
      extension: phone.extension,
      label: phone.label ?? '',
      note: phone.note,
  ...
  deletePhone: async (location, id, phoneId) => {
    const response = await administratorApi.deleteAdministratorPhone(location, id, phoneId);
    return response?.success ?? false;
  },
  ...
  createAddress: async (location, id, address) => {
    const response = await administratorApi.addAdministratorAddress(location, id, {
  ...
  updateAddress: async (location, id, addressId, address) => {
    const response = await administratorApi.updateAdministratorAddress(location, id, parseInt(addressId), {
      address: address.address ?? '',
      city: address.city ?? '',
  ...
  deleteAddress: async (location, id, addressId) => {
    const response = await administratorApi.deleteAdministratorAddress(location, id, addressId);
    return response?.success ?? false;
  },
};
