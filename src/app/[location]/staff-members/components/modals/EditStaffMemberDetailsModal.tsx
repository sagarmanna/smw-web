...
interface EditStaffMemberDetailsModalProps {
  open: boolean;
  onClose: () => void;
  details: StaffMemberBasicDetails | null;
  onSubmit: (details: StaffMemberBasicDetails) => Promise<boolean>;
  saving?: boolean;
}

export function EditStaffMemberDetailsModal({
  open,
  onClose,
  details,
  onSubmit,
  saving = false,
}: EditStaffMemberDetailsModalProps) {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const updatedDetails: StaffMemberBasicDetails = {
